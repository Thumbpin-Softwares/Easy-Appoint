...
function Strip() {
    return (
        <>
            {data.map((item) => (
                <div key={item} className="flex shrink-0 bg-[#00C2FF] py-3 sm:py-4 items-center">
...
export default function Booking(){
    return(
        <main className="bg-[#1b3a52] border-b border-b-neutral-500 pb-16 sm:pb-32 flex flex-col items-center justify-center">
            ...
            <Button style="bg-[#00C2FF] rounded-full" name="Book Now" link="/" />
        </main>
    );
}
