        ...
        <>
            {text.map((word, index) => (
                <div key={index} className="flex shrink-0 items-center gap-6 sm:gap-12 lg:gap-18 pr-6 sm:pr-8 lg:pr-12">
                    ...
                    <div className="h-6 w-6 sm:h-10 sm:w-10 lg:h-16 lg:w-16 shrink-0 rotate-45 bg-[#00C2FF]" />
                </div>
            ))}
        </>
    );
...
export default function Cta(){
    return(
        <main className="bg-[#1b3a52] h-[25vh] sm:h-[35vh] lg:h-[50vh] flex items-center overflow-hidden">
            <motion.div
